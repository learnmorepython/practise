...
def laser_weapon_armory():
    ...
    for more Got hons that might be hiding. It'sdead quiet, too quiet.
...
def escape_pod():
    ...
    but you don't have time to look. There's 5pods, which one do you take?
    """
    ...
    if int(guess) != good_pod:
        ...
        print """
        You jump into pod %s and hit the eject button.
        The pod easily slides out into space heading print 
        the planet below. As it flies to the planet, you look
        back and see your ship implode then explode like a 
        bright star, taking out the Gothon ship at the same time. You won!""" % guess
        exit(0)
